...
var GiftCardService = /** @class */ (function (_super) {
    ...
    GiftCardService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, giftCardRepo, q, query, rels;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, giftCardRepo.listGiftCardsAndCount(query, rels, q)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rels = query.relations;
                        delete query.relations;
                        return [4 /*yield*/, giftCardRepo.listGiftCards(query, rels, q)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    GiftCardService.prototype.createTransaction = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, gctRepo, created, saved;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
    ...
    */
    ...
    GiftCardService.prototype.retrieve_ = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, giftCardRepo, _a, relations, query, giftCard, selectorConstraints;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, giftCardRepo.findOneWithRelations(relations, query)];
                    case 1:
                        giftCard = _b.sent();
                        if (!giftCard) {
    ...
    GiftCardService.prototype.delete = function (giftCardId) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, giftCardRepo, giftCard;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
