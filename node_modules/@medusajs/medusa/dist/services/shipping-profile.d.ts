...
declare class ShippingProfileService extends TransactionBaseService {
    ...
    constructor({ manager, shippingProfileRepository, productService, productRepository, shippingOptionService, customShippingOptionService, }: InjectedDependencies);
    /**
    ...
    fetchOptionsByProductIds(productIds: string[], filter: Selector<ShippingOption>): Promise<ShippingOption[]>;
    /**
    ...
    retrieveDefault(): Promise<ShippingProfile | undefined>;
    /**
     ...
     */
    retrieveGiftCardDefault(): Promise<ShippingProfile | undefined>;
    /**
