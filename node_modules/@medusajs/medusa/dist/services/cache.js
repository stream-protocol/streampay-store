...
var CacheService = /** @class */ (function () {
    function CacheService(_a) {
        var redisClient = _a.redisClient;
    ...
    CacheService.prototype.set = function (key, data, ttl) {
        var _a;
        if (ttl === void 0) { ttl = DEFAULT_CACHE_TIME; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ttl = Number((_a = process.env.CACHE_TTL) !== null && _a !== void 0 ? _a : ttl);
                        if (ttl === 0) {
                            // No need to call redis set without expiry time
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.redis_.set(key, JSON.stringify(data), EXPIRY_MODE, ttl)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    CacheService.prototype.invalidate = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.redis_.keys(key)];
                    case 1:
                        keys = _a.sent();
                        pipeline = this.redis_.pipeline();
