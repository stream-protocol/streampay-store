...
var CurrencyService = /** @class */ (function (_super) {
    ...
    function CurrencyService(_a) {
        var manager = _a.manager, currencyRepository = _a.currencyRepository, eventBusService = _a.eventBusService, featureFlagRouter = _a.featureFlagRouter;
    ...
    CurrencyService.prototype.retrieveByCode = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currencyRepo = this.manager_.getCustomRepository(this.currencyRepository_);
    ...
    CurrencyService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productRepo = this.manager_.getCustomRepository(this.currencyRepository_);
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        currencyRepo = transactionManager.getCustomRepository(this.currencyRepository_);
                                        return [4 /*yield*/, currencyRepo.save(currency)];
                                    case 2:
                                        _a.sent();
                                        return [4 /*yield*/, this.eventBusService_.emit(CurrencyService.Events.UPDATED, {
                                                code: code,
                                            })];
                                    case 3:
                                        _a.sent();
