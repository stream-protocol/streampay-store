...
var OrderEditItemChangeService = /** @class */ (function (_super) {
    ...
    function OrderEditItemChangeService(_a) {
        var manager = _a.manager, orderItemChangeRepository = _a.orderItemChangeRepository, eventBusService = _a.eventBusService, lineItemService = _a.lineItemService, taxProviderService = _a.taxProviderService;
        var _this = 
    ...
    OrderEditItemChangeService.prototype.retrieve = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, orderItemChangeRepo, query, itemChange;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = (_a = this.transactionManager_) !== null && _a !== void 0 ? _a : this.manager_;
                        orderItemChangeRepo = manager.getCustomRepository(this.orderItemChangeRepository_);
    ...
    OrderEditItemChangeService.prototype.list = function (selector, config) {
        ...
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var manager, orderItemChangeRepo, query;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = (_a = this.transactionManager_) !== null && _a !== void 0 ? _a : this.manager_;
