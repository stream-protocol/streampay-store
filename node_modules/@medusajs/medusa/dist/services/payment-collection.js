...
var PaymentCollectionService = /** @class */ (function (_super) {
    ...
    function PaymentCollectionService(_a) {
        var manager = _a.manager, paymentCollectionRepository = _a.paymentCollectionRepository, paymentProviderService = _a.paymentProviderService, customerService = _a.customerService, eventBusService = _a.eventBusService;
        var _this = 
    ...
    PaymentCollectionService.prototype.retrieve = function (paymentCollectionId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, paymentCollectionRepository, paymentCollection, query;
