...
var ProductCategoryService = /** @class */ (function (_super) {
    ...
    function ProductCategoryService(_a) {
        var manager = _a.manager, productCategoryRepository = _a.productCategoryRepository, eventBusService = _a.eventBusService;
        var _this = 
    ...
    ProductCategoryService.prototype.listAndCount = function (selector, config, treeSelector) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, productCategoryRepo, selector_, q, query;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = (_a = this.transactionManager_) !== null && _a !== void 0 ? _a : this.manager_;
                        productCategoryRepo = manager.getCustomRepository(this.productCategoryRepo_);
                        ...
                        return [4 /*yield*/, productCategoryRepo.getFreeTextSearchResultsAndCount(query, q, treeSelector)];
     ...
     */
    ProductCategoryService.prototype.retrieve = function (productCategoryId, config, selector) {
        if (config === void 0) { config = {}; }
        if (selector === void 0) { selector = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var selectors, query, productCategoryRepo, productCategory, productCategoryTree;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = (0, utils_1.buildQuery)(selectors, config);
                        productCategoryRepo = this.manager_.getCustomRepository(this.productCategoryRepo_);
                        return [4 /*yield*/, productCategoryRepo.findOne(query)];
                    case 1:
                        productCategory = _a.sent();
                        if (!productCategory) {
                            throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_FOUND, "ProductCategory with id: ".concat(productCategoryId, " was not found"));
                        }
                        return [4 /*yield*/, productCategoryRepo.findDescendantsTree(productCategory)];
                    case 2:
                        productCategoryTree = _a.sent();
                        return [2 /*return*/, productCategoryTree];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var pcRepo, productCategory;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        pcRepo = manager.getCustomRepository(this.productCategoryRepo_);
    ...
    ProductCategoryService.prototype.update = function (productCategoryId, productCategoryInput) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var productCategoryRepo, productCategory, key;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        productCategoryRepo = manager.getCustomRepository(this.productCategoryRepo_);
    ...
    ProductCategoryService.prototype.delete = function (productCategoryId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var productCategoryRepository, productCategory;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        productCategoryRepository = manager.getCustomRepository(this.productCategoryRepo_);
                                        return [4 /*yield*/, this.retrieve(productCategoryId, {
