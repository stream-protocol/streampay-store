...
var PublishableApiKeyService = /** @class */ (function (_super) {
    ...
    function PublishableApiKeyService(_a) {
        var manager = _a.manager, eventBusService = _a.eventBusService, publishableApiKeyRepository = _a.publishableApiKeyRepository, publishableApiKeySalesChannelRepository = _a.publishableApiKeySalesChannelRepository;
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        pubKeySalesChannelRepo = transactionManager.getCustomRepository(this.publishableApiKeySalesChannelRepository_);
    ...
    PublishableApiKeyService.prototype.listSalesChannels = function (publishableApiKeyId, config) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, pubKeySalesChannelRepo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                        pubKeySalesChannelRepo = manager.getCustomRepository(this.publishableApiKeySalesChannelRepository_);
    ...
    PublishableApiKeyService.prototype.getResourceScopes = function (publishableApiKeyId) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, pubKeySalesChannelRepo, salesChannels;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                sales_channel_id: salesChannels.map(function (_a) {
