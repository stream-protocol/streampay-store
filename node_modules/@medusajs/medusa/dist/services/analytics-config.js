...
var AnalyticsConfigService = /** @class */ (function (_super) {
    ...
    function AnalyticsConfigService(_a) {
        var analyticsConfigRepository = _a.analyticsConfigRepository, manager = _a.manager;
        var _this = 
    ...
    AnalyticsConfigService.prototype.retrieve = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, analyticsRepo, analyticsConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                        analyticsRepo = manager.getCustomRepository(this.analyticsConfigRepository_);
    ...
    AnalyticsConfigService.prototype.create = function (userId, data) {
        return __awaiter(this, void 0, void 0, function () {
            var manager, analyticsRepo, config;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    AnalyticsConfigService.prototype.update = function (userId, update) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var manager, analyticsRepo, config, _c, _d, _e, key, value;
            var e_1, _f;
