    ...
    function ProductSearchSubscriber(container) {
        ...
        this.handleProductCreation = function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieveProduct_(data.id)];
                    case 1:
                        product = _a.sent();
        ...
        this.retrieveProduct_ = function (product_id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productService_.retrieve(product_id, {
                            select: searchFields,
        ...
        this.handleProductVariantChange = function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieveProduct_(data.product_id)];
                    case 1:
                        product = _a.sent();
                        return [4 /*yield*/, this.searchService_.addDocuments(product_1.default.IndexName, [product], medusa_core_utils_1.indexTypes.products)];
                    case 2:
