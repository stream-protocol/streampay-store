...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var args, babelPath, cliPath, child;
        return __generator(this, function (_b) {
            ...
            cliPath = path_1.default.join(directory, "node_modules", ".bin", "medusa");
            child = (0, cross_spawn_1.default)(cliPath, __spreadArray(["start"], __read(args), false), {
                cwd: directory,
                env: process.env,
                stdio: ["pipe", process.stdout, process.stderr],
            });
            chokidar_1.default.watch("".concat(directory, "/src")).on("change", function (file) {
                ...
                child.kill("SIGINT");
                (0, child_process_1.execSync)("".concat(babelPath, " src -d dist --extensions \".ts,.js\""), {
                    cwd: directory,
                    stdio: ["pipe", process.stdout, process.stderr],
                });
