...
var migrate = function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var connection, BATCH_SIZE, noDanglingProductsValidation;
        var _this = this;
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 1:
                                                        ...
                                                        discountConditionRepo = manager
                                                            .getCustomRepository(discount_condition_2.DiscountConditionRepository);
                                                        return [4 /*yield*/, manager
                                                                .createQueryBuilder()
                                                                .insert()
                                                                .into(discount_condition_1.DiscountCondition)
                                                                .values(discountRules.map(function (dr) { return discountConditionRepo.create({
