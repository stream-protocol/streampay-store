...
var migrateProductVariant = function (variant, locationId, _a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var productVariantInventoryService, inventoryService, inventoryItem;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, productVariantInventoryService.attachInventoryItem(variant.id, inventoryItem.id, 1)];
                case 2:
                    _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(variants.map(function (variant) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, migrateProductVariant(variant, locationId, { container: container })];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
