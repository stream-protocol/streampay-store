...
var SwapRepository = /** @class */ (function (_super) {
    __extends(SwapRepository, _super);
    function SwapRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SwapRepository.prototype.findWithRelations = function (relations, optionsWithoutRelations) {
    ...
    SwapRepository.prototype.findOneWithRelations = function (relations, optionsWithoutRelations) {
        if (relations === void 0) { relations = []; }
        if (optionsWithoutRelations === void 0) { optionsWithoutRelations = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
    ...
    SwapRepository = __decorate([
        (0, typeorm_1.EntityRepository)(swap_1.Swap)
    ], SwapRepository);
