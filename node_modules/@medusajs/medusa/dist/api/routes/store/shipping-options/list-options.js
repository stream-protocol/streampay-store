...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, productIds, regionId, productService, pricingService, shippingOptionService, query, prods, options, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, productService.list({ id: productIds })];
            case 2:
                prods = _a.sent();
                query.profile_id = prods.map(function (p) { return p.profile_id; });
                _a.label = 3;
            case 3: return [4 /*yield*/, shippingOptionService.list(query, {
