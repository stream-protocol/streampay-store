...
exports.StoreGetProductCategoryParams = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, productCategoryService.retrieve(id, retrieveConfig, _1.defaultStoreScope)];
            case 1:
                ...
                res.status(200).json({
                    ...
                    product_category: (0, tree_1.transformTreeNodesWithConfig)(productCategory, retrieveConfig, _1.defaultStoreScope),
                });
                return [2 /*return*/];
        }
    });
}); });
var StoreGetProductCategoryParams = /** @class */ (function (_super) {
    __extends(StoreGetProductCategoryParams, _super);
    function StoreGetProductCategoryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return StoreGetProductCategoryParams;
}(common_1.FindParams));
exports.StoreGetProductCategoryParams = StoreGetProductCategoryParams;
