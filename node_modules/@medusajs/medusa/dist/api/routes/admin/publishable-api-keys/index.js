...
var list_publishable_api_key_sales_channels_1 = require("./list-publishable-api-key-sales-channels");
...
exports.default = (function (app) {
    ...
    route.get("/:id/sales-channels", (0, middlewares_1.transformQuery)(list_publishable_api_key_sales_channels_1.GetPublishableApiKeySalesChannelsParams, { isList: true }), middlewares_1.default.wrap(require("./list-publishable-api-key-sales-channels").default));
