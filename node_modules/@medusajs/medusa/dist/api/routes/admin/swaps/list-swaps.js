...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var swapService, _a, offset, limit, selector, listConfig, swaps;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), offset = _a.offset, limit = _a.limit;
                selector = {};
                listConfig = {
                    skip: offset,
                    take: limit,
                ...
                return [4 /*yield*/, swapService.list(selector, __assign({}, listConfig))];
            case 2:
                swaps = _b.sent();
                res.json({ swaps: swaps, count: swaps.length, offset: offset, limit: limit });
                return [2 /*return*/];
        }
    });
}); });
