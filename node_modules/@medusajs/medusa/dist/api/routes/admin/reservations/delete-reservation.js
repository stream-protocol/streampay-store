...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                inventoryService = req.resolve("inventoryService");
                manager = req.resolve("manager");
                return [4 /*yield*/, manager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, inventoryService.withTransaction(manager).deleteReservationItem(id)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
