...
var getLevelsByInventoryItemId = function (items, locationIds, inventoryService) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, levels, levelsWithAvailability;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, inventoryService.listInventoryLevels({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, inventoryItems.map(function (inventoryItem) { return (__assign(__assign({}, inventoryItem), { location_levels: levelsByItemId[inventoryItem.id] || [] })); })];
        }
    });
}); };
