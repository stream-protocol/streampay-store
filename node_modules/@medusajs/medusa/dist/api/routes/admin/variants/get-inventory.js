...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, inventoryService, channelService, productVariantInventoryService, variantService, variant, responseVariant, _a, channels, inventory, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _a = __read.apply(void 0, [_d.sent(), 1]), channels = _a[0];
            ...
            case 4:
                ...
                if (!inventory.length) return [3 /*break*/, 6];
                _c = responseVariant;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, inventoryService.retrieveAvailableQuantity(inventory[0].id, channel.locations.map(function (loc) { return loc.id; }))];
                                case 1:
                                    quantity = _a.sent();
                                    return [2 /*return*/, {
                                            channel_name: channel.name,
